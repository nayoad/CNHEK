...
-- 新增：主/副手武器类型与子类型识别，补齐装备信息并映射武器子类。开发：杰瑞
local GetItemInfoInstant = _G.GetItemInfoInstant
local RC = LibStub( "LibRangeCheck-2.0" )
local ITEM_CLASS_WEAPON = _G.ITEM_CLASS_WEAPON
local WEAPON_CLASS_ID = _G.LE_ITEM_CLASS_WEAPON or ( Enum and Enum.ItemClass and Enum.ItemClass.Weapon ) or 2

local weaponSubClassIdToKey = {}
local function AddWeaponSubClassId( id, key )
    if id ~= nil then weaponSubClassIdToKey[ id ] = key end
end

if Enum and Enum.ItemWeaponSubclass then
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.Dagger, "dagger" )
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.Sword1H, "sword_1h" )
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.Sword2H, "sword_2h" )
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.Axe1H, "axe_1h" )
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.Axe2H, "axe_2h" )
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.Mace1H, "mace_1h" )
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.Mace2H, "mace_2h" )
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.Polearm, "polearm" )
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.Staff, "staff" )
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.FistWeapon, "fist" )
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.Wand, "wand" )
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.Bow, "bow" )
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.Gun, "gun" )
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.Crossbow, "crossbow" )
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.Thrown, "thrown" )
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.Fishingpole, "fishingpole" )
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.Warglaive, "warglaive" )
    AddWeaponSubClassId( Enum.ItemWeaponSubclass.Miscellaneous, "misc" )
else
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_DAGGER, "dagger" )
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_SWORD1H, "sword_1h" )
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_SWORD2H, "sword_2h" )
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_AXE1H, "axe_1h" )
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_AXE2H, "axe_2h" )
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_MACE1H, "mace_1h" )
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_MACE2H, "mace_2h" )
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_POLEARM, "polearm" )
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_STAFF, "staff" )
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_UNARMED, "fist" )
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_WAND, "wand" )
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_BOWS, "bow" )
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_GUNS, "gun" )
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_CROSSBOW, "crossbow" )
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_THROWN, "thrown" )
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_FISHINGPOLE, "fishingpole" )
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_WARGLAIVE, "warglaive" )
    AddWeaponSubClassId( _G.LE_ITEM_WEAPON_MISCELLANEOUS, "misc" )
end

local weaponSubTypeToKey = {}
local function AddWeaponSubType( name, key )
    if name then weaponSubTypeToKey[ name ] = key end
end

AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_DAGGER, "dagger" )
AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_SWORD1H, "sword_1h" )
AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_SWORD2H, "sword_2h" )
AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_AXE1H, "axe_1h" )
AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_AXE2H, "axe_2h" )
AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_MACE1H, "mace_1h" )
AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_MACE2H, "mace_2h" )
AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_POLEARM, "polearm" )
AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_STAFF, "staff" )
AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_FIST, "fist" )
AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_WAND, "wand" )
AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_BOW, "bow" )
AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_GUN, "gun" )
AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_CROSSBOW, "crossbow" )
AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_THROWN, "thrown" )
AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_FISHINGPOLE, "fishingpole" )
AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_WARGLAIVE, "warglaive" )
AddWeaponSubType( _G.ITEM_SUBCLASS_WEAPON_MISCELLANEOUS, "misc" )

local function NormalizeWeaponType( itemType, itemSubType, classID, subClassID, equipLoc )
    local isWeapon = ( classID and classID == WEAPON_CLASS_ID )
        or ( itemType and ITEM_CLASS_WEAPON and itemType == ITEM_CLASS_WEAPON )
        or ( equipLoc and ( equipLoc:match( "WEAPON" ) or equipLoc:match( "RANGED" ) ) )

    if not isWeapon then return nil, itemSubType end

    if ( not itemSubType or itemSubType == "" ) and classID and subClassID and GetItemSubClassInfo then
        itemSubType = GetItemSubClassInfo( classID, subClassID )
    end

    if classID == WEAPON_CLASS_ID and subClassID ~= nil and weaponSubClassIdToKey[ subClassID ] then
        return weaponSubClassIdToKey[ subClassID ], itemSubType
    end

    return itemSubType and weaponSubTypeToKey[ itemSubType ] or nil, itemSubType
end
...
do
    ...
    function ns.updateGear()
        ...
        state.main_hand.type = nil
        state.main_hand.subtype = nil
        state.main_hand.class = nil
        state.main_hand.class_id = nil
        state.main_hand.subclass_id = nil
        state.main_hand.equip_loc = nil

        state.off_hand.size = 0
        state.off_hand.type = nil
        state.off_hand.subtype = nil
        state.off_hand.class = nil
        state.off_hand.class_id = nil
        state.off_hand.subclass_id = nil
        state.off_hand.equip_loc = nil
        ...
        for i = 1, 19 do
            ...
            if item then
                ...
                local key, _, _, _, _, itemType, itemSubType, _, equipLoc, _, _, classID, subClassID = CGetItemInfo( item )
                if GetItemInfoInstant and ( not itemType or not itemSubType or not equipLoc or classID == nil or subClassID == nil ) then
                    local _, iType, iSubType, iEquip, _, iClass, iSubClass = GetItemInfoInstant( item )
                    itemType = itemType or iType
                    itemSubType = itemSubType or iSubType
                    equipLoc = equipLoc or iEquip
                    classID = classID or iClass
                    subClassID = subClassID or iSubClass
                end
                if key then
                    key = formatKey( key )
                ...
                if i == 16 then
                    local weaponType, resolvedSubType = NormalizeWeaponType( itemType, itemSubType, classID, subClassID, equipLoc )
                    state.main_hand.type = weaponType
                    state.main_hand.subtype = resolvedSubType
                    state.main_hand.class = itemType
                    state.main_hand.class_id = classID
                    state.main_hand.subclass_id = subClassID
                    state.main_hand.equip_loc = equipLoc
                ...
                elseif i == 17 then
                    local weaponType, resolvedSubType = NormalizeWeaponType( itemType, itemSubType, classID, subClassID, equipLoc )
                    state.off_hand.type = weaponType
                    state.off_hand.subtype = resolvedSubType
                    state.off_hand.class = itemType
                    state.off_hand.class_id = classID
                    state.off_hand.subclass_id = subClassID
                    state.off_hand.equip_loc = equipLoc
