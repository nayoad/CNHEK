                                ...
                                func = function ()
                                    ...
                                    if spec then
                                        ...
                                        if Hekili.DB.profile.notifications.enabled then
                                            Hekili:Notify( "Pack Selector: " .. ( spec.selector and "ON" or "OFF" ) )
                                        else
                                            self:Print( "Pack Selector: " .. ( spec.selector and " |cFF00FF00ENABLED|r." or " |cFFFF0000DISABLED|r." ) )
                                        end
                                    end
                                end,
                                checked = function ()
