...
local mt_weapon_type = {
    __index = function( t, k )
        ...
        local wt = rawget( t, "type" )
        if not wt then return false end

        if k == "dagger" then return wt == "dagger" end
        if k == "fist" or k == "fist_weapon" then return wt == "fist" end
        if k == "polearm" then return wt == "polearm" end
        if k == "staff" then return wt == "staff" end
        if k == "wand" then return wt == "wand" end
        if k == "bow" then return wt == "bow" end
        if k == "gun" then return wt == "gun" end
        if k == "crossbow" then return wt == "crossbow" end
        if k == "thrown" then return wt == "thrown" end
        if k == "fishingpole" or k == "fishing_pole" then return wt == "fishingpole" end
        if k == "warglaive" then return wt == "warglaive" end
        if k == "misc" or k == "miscellaneous" then return wt == "misc" end

        if k == "sword" then return wt == "sword_1h" or wt == "sword_2h" end
        if k == "sword_1h" or k == "1h_sword" or k == "one_handed_sword" then return wt == "sword_1h" end
        if k == "sword_2h" or k == "2h_sword" or k == "two_handed_sword" then return wt == "sword_2h" end

        if k == "axe" then return wt == "axe_1h" or wt == "axe_2h" end
        if k == "axe_1h" or k == "1h_axe" or k == "one_handed_axe" then return wt == "axe_1h" end
        if k == "axe_2h" or k == "2h_axe" or k == "two_handed_axe" then return wt == "axe_2h" end

        if k == "mace" then return wt == "mace_1h" or wt == "mace_2h" end
        if k == "mace_1h" or k == "1h_mace" or k == "one_handed_mace" then return wt == "mace_1h" end
        if k == "mace_2h" or k == "2h_mace" or k == "two_handed_mace" then return wt == "mace_2h" end
